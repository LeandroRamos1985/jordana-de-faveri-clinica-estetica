...
| 56 | Fotos autorizadas | Atenção | Poster original aprovado para demonstração; retrato da Dra. baseado no print enviado, autorização final de uso ainda pendente |
